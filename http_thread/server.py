...
class OthelloServer(threading.Thread):
    ...
    def run(self):
        try:
            ...
            logging.info(f"🌐 Server URL: http://localhost:{self.port}")
            logging.info(f"📝 Run 'python client.py' to connect from another terminal")
            logging.info("=" * 60)
...
def main():
    try:
        ...
        print()
        print("📋 Instructions:")
        print("  1. Server will start and wait for connections")
        print("  2. Run 'python client.py' in another terminal to connect")
        print("  3. Or manually open browser to http://localhost:8889")
        print("=" * 50)
